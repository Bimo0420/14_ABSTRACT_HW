...
namespace N //Разработать абстрактный класс Animal, который описывает животное. Класс содержит следующие элементы:
...
//Создайте экземпляры классов Cat и Dog и проверьте их работоспособность.
{
    internal class Program
    {
        ...
        {
            Dog dog = new Dog("Хороший Мальчик", "Гав");
            dog.ShowInfo();
            Cat cat = new Cat("по имени Гав");
            cat.ShowInfo();
            Console.ReadKey();
